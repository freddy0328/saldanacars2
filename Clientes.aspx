<%@ Page Title="Clientes" Language="C#" Debug="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clientes.aspx.cs" Inherits="saldanacars2.Clientes" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <asp:Label ID="lblNombredelcliente" runat="server"  CssClass="ancho" Text="Nombredelcliente"></asp:Label>
          <asp:TextBox ID="txtlblNombredelcliente" runat="server" ></asp:TextBox><br />
